...
class MessageWithEmojisLayout @JvmOverloads constructor(
    ...
    init {
        ...
        messageLayout = findViewById(R.id.ml)
        avatarView = findViewById(R.id.iv_avatar)
        reactionsLayout = findViewById(R.id.fbl)
        if (attrs != null) {
    ...
    private fun setAttributes() {
        messageLayout.name.text = authorName
    ...
    companion object {
        ...
        private const val DEFAULT_AVATAR = R.mipmap.ic_launcher
    }
}
